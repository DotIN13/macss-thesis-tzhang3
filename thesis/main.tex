...
I hypothesize that these specific visual sequence tokens can be probed natively utilizing my text-trained ideology probe. I provide the VLM with politically charged images (e.g., politicians, rallies) and generic uncaptioned imagery from Unsplash, accompanied by a benign textual prompt: \textit{"Describe the contents of this image in one sentence."}
